          ...
          child: Column(
            children: [
              ...
              GestureDetector(
                ...
                child: Padding(
                  padding: EdgeInsets.fromLTRB(0.0, pageHeight*0.03, 0.0, pageHeight*0.03),
              ...
              Padding(
                padding: EdgeInsets.symmetric(vertical: pageHeight*0.02, horizontal: pageWidth*0.1),
                child: Column(
                  children: [
                    Padding(
                      padding: EdgeInsets.all(pageWidth*0.015),
                      child: TextField(
              ...
              Padding(
                padding: EdgeInsets.all(pageHeight*0.03),
